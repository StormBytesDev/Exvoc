...
package com.stormbytes.exvoc.tileentity.steamworks;
...
public class TileEntityGrinder extends TileEntityExvoc implements IDropInventory, IHasGui {
    ...
    @Override
    public void onBlockActivated(EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) { }

    @Override
    public int getGUI() { return GUIManager.GRINDER; }
